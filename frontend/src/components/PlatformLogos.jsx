...
function LogoYouTube() {
  return (
    <svg viewBox="0 0 24 24" className="platform-logo-svg" aria-hidden="true">
      <path fill="#FF0000" d="M23.5 6.2a3 3 0 00-2.1-2.1C19.5 3.5 12 3.5 12 3.5s-7.5 0-9.4.6A3 3 0 00.5 6.2 30 30 0 000 12a30 30 0 00.6 5.8 3 3 0 002.1 2.1c1.9.6 9.4.6 9.4.6s7.5 0 9.4-.6a3 3 0 002.1-2.1 30 30 0 00.6-5.8 30 30 0 00-.6-5.8zM9.75 15.02V8.98L15.5 12l-5.75 3.02z" />
    </svg>
  )
}
...
function LogoTikTok() {
  return (
    <svg viewBox="0 0 24 24" className="platform-logo-svg platform-logo-tiktok" aria-hidden="true">
      <path
        fill="currentColor"
...
function LogoX() {
  return (
    <svg viewBox="0 0 24 24" className="platform-logo-svg platform-logo-x" aria-hidden="true">
...
const PLATFORMS = [
  { name: 'YouTube', Logo: LogoYouTube, to: '/youtube-downloader' },
  { name: 'Instagram', Logo: LogoInstagram, to: '/instagram-downloader' },
  { name: 'TikTok', Logo: LogoTikTok, to: '/tiktok-downloader' },
  { name: 'X', Logo: LogoX, to: '/' },
  { name: 'Facebook', Logo: LogoFacebook, to: '/' },
  { name: 'Vimeo', Logo: LogoVimeo, to: '/' },
]

export default function PlatformLogos() {
  return (
    <section className="platform-logos section-block" aria-labelledby="platforms-heading">
      <h2 id="platforms-heading" className="section-title">
        Supported platforms
      </h2>
      <p className="section-lead">
        Optimized for the sites you use every day — plus 1000+ more via yt-dlp.
      </p>
      <ul className="platform-grid">
        {PLATFORMS.map(({ name, Logo, to }) => (
          <li key={name}>
            <Link to={to} className="platform-card" title={`${name} downloader`}>
